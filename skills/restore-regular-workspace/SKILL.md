...
4. Explain that the canonical checkout will move back to the container path and the generated container scaffold will be removed. Show the exact source, destination, and scaffold paths, then ask the user to confirm the move.
